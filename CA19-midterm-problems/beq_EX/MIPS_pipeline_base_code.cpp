...
void printState(stateStruct state, int cycle)
{
    ...
    if (printstate.is_open())
    {
        ...
        else
        {
            ...
            if ("beq" == state.EX.INS)
            {
                printstate<<"EX.Read_data1:\t"<<EX.Read_data1<<endl;
                printstate<<"EX.Read_data2:\t"<<EX.Read_data2<<endl;
                printstate<<"EX.Imm:\t"<<EX.Imm<<endl;
                printstate<<"EX.Rs:\t"<<"X"<<endl;
                printstate<<"EX.Rt:\t"<<"X"<<endl;
                printstate<<"EX.Wrt_reg_addr:\t"<<"X"<<endl;
                printstate<<"EX.is_I_type:\t"<<EX.is_I_type<<endl;
                printstate<<"EX.rd_mem:\t"<<state.EX.rd_mem<<endl;
                printstate<<"EX.wrt_mem:\t"<<state.EX.wrt_mem<<endl;
                printstate<<"EX.alu_op:\t"<<"X"<<endl;
                printstate<<"EX.wrt_enable:\t"<<state.EX.wrt_enable<<endl;
